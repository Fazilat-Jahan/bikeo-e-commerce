...
export default function BikePage({ params }: { params: { id:any } }) {
  ...
  if (!bike) {
    return <div className="container mx-auto px-4 py-8 text-center">Bike not found</div>
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <Link href="/brands" className="text-red-800 hover:text-red-500 mb-4 inline-block">&larr; Back to Inventory</Link>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p className="text-xl text-red-800 mb-4">${bike.price.toLocaleString()}</p>
